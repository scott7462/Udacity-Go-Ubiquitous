...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    /**
     * Add the static values to connect with wear face
     */
    ...
    private void notifyWatchFace() {
        ...
        weatherDataMap.putString(HIGH_TEMPERATURE, Utility.formatTemperature(getContext(), cursor.getDouble(INDEX_MAX_TEMP)));
        weatherDataMap.putString(LOW_TEMPERATURE, Utility.formatTemperature(getContext(), cursor.getDouble(INDEX_MIN_TEMP)));
